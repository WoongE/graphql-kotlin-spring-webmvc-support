...
import io.github.woong.graphql.server.types.GraphQLServerError
import io.github.woong.graphql.server.types.GraphQLSourceLocation
...
fun ExecutionResult.toGraphQLResponse(): GraphQLResponse<*> {
    ...
    val filteredErrors: List<GraphQLServerError>? =
 ...
 */
fun GraphQLError.toGraphQLKotlinType() =
    GraphQLServerError(
 ...
 */
internal fun SourceLocation.toGraphQLKotlinType() =
