...
import io.github.woong.graphql.server.exception.MissingDataLoaderException
 ...
 */
fun <K, V> DataFetchingEnvironment.getValueFromDataLoader(
 ...
 */
fun <K, V> DataFetchingEnvironment.getValuesFromDataLoader(
    dataLoaderName: String,
    keys: List<K>,
 ...
 */
inline fun <reified T> DataFetchingEnvironment.getFromContext(): T? = graphQlContext.get<T>()
 ...
 */
inline fun <reified T> DataFetchingEnvironment.getFromContextOrDefault(defaultValue: T): T = graphQlContext.getOrDefault(defaultValue)
 ...
 */
inline fun <reified T> DataFetchingEnvironment.getFromContextOrElse(defaultValue: () -> T): T = graphQlContext.getOrElse(defaultValue)
 ...
 */
inline fun <reified T> DataFetchingEnvironment.getFromContextOrThrow(): T = graphQlContext.getOrThrow()
