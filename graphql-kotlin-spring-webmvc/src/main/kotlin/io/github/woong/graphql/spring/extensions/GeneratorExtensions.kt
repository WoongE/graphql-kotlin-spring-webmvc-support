...
package io.github.woong.graphql.spring.extensions
 ...
 */
internal fun List<Any>.toTopLevelObjects(): List<TopLevelObject> =
    this.map {
        it.toTopLevelObject()
    }
 ...
 */
internal fun Any.toTopLevelObject(): TopLevelObject =
    this.let {
        val klazz =
